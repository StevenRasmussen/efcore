...
namespace Microsoft.EntityFrameworkCore.Query
{
    ...
    public class ShapedQueryExpression : Expression, IPrintableExpression
    {
        ...
        /// <summary>
        ///     An expression representing query to be run against server to get results.
        /// </summary>
        ...
        /// <summary>
        ///     An expression reprensing the shaper to be run on the results fetched from the server.
        /// </summary>
