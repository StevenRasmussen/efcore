...
{
    /// <summary>
    ///     Convention that converts accesses of DbSet inside query filters and defining queries into <see cref="QueryRootExpression"/>.
    ...
    public class QueryFilterDefiningQueryRewritingConvention : IModelFinalizingConvention
    {
        ...
        /// <summary>
        ///     Visitor used to rewrite DbSet accesses encountered in query filters and defining queries to <see cref="QueryRootExpression"/>.
        /// </summary>
